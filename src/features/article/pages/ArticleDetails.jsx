        ...
        <div className="article-container">
          <main className="article-main">
            ...
            <p className="article-lead">
              ...
              Lý, có bài báo trên tạp chí Q1, trước khi tốt nghiệp thủ khoa Đại
              học Phenikaa.
            </p>
            <p>
            ...
            <p>
              ...
              bổng vào chương trình Vật lý tài năng. Nam sinh cho hay muốn học
              sâu về ngành này bởi thấy có thể áp dụng vào nhiều lĩnh vực trong
              thực tiễn, chọn Phenikaa vì trường có nhiều giảng viên tu nghiệp ở
              nước ngoài về.
            </p>
            ...
            <p>
              ...
              Lượng thấm thía tầm quan trọng của tự học. Nhưng ở đại học, nam
              sinh thấy tinh thần này phải "gấp 10 lần". Ngoài xem lại giáo
              trình, Lượng học từ các bài báo khoa học, tài liệu trên mạng.
            </p>

            <p>
              Chỉ sau 2 tháng bắt nhịp, Lượng thử sức với kỳ thi Olympic Toán
              sinh viên toàn quốc và giành cú đúp huy chương đồng (môn Đại số
              tuyến tính và Giải tích). Hai năm tiếp theo, nam sinh quay lại thế
              mạnh sở trường khi thi Olympic Vật lý. Với lịch ôn luyện 3-4 buổi
              mỗi tuần, có giai đoạn cao điểm học 15 tiếng một ngày, Lượng giành
              3 giải nhất trong hai lần tham dự, ở cả nội dung bài tập cá nhân
              và trắc nghiệm đồng đội.
            </p>

            <p>
              Đại học Phenikaa cho biết hiếm sinh viên nào ở trường đạt nhiều
              giải Olympic toàn quốc ở cả Toán và Vật lý như Lượng. Dù vậy, nam
              sinh cho rằng giai đoạn tham gia nghiên cứu khoa học, từ đầu năm
              thứ ba, căng thẳng hơn.
            </p>

            <p>
              "Bởi có nhiều thứ lạ lẫm và vô cùng nhức đầu", Lượng kể. "Nhiều
              hôm, mình bỏ cả ăn tối, ở trường đến nửa đêm để làm".
            </p>
            ...
            <p>
              ...
              đến nay. Từ chỗ chỉ tham gia lập trình ứng dụng, website, hiện
              Lượng là nhân sự nghiên cứu AI với hướng chính là dùng Vật lý để
              huấn luyện AI hiểu đúng bản chất của thế giới.
            </p>

            <p>
              Lượng cùng đồng nghiệp đã có hai bài báo được chấp nhận tại hội
              nghị AAAI vừa diễn ra tại Singapore và AAMAS tổ chức tại Nhật Bản
              vào tháng 5 tới. Đây đều là những hội nghị uy tín hàng đầu trong
