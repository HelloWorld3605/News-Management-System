        ...
        <div className="author-container">
          <main className="author-main">
            ...
            <div className="author-details-content">
              <p>
                Tác giả Phùng Tuấn Hải làm việc trong lĩnh vực công nghệ, truyền
                thông và chuyển đổi số, đồng thời phát triển các giải pháp phần
                mềm cho doanh nghiệp. Anh quan tâm đến giáo dục, đời sống đô thị
                và những chuyển biến xã hội trong thời đại số.
              </p>
            </div>

            <div className="list-article">
              <h3 className="list-article-title">Bài viết</h3>
              <ul className="list-article-list">
                <li className="list-article-item">
                  <h2 className="list-article-item-title">
                    <Link to="/article-details">
                      Thủ khoa giành 5 giải Olympic Toán, Lý toàn quốc
                    </Link>
                  </h2>
                  <p className="list-article-item-content">
                    Đoàn Minh Lượng từng giành 5 giải Olympic toàn quốc môn Toán
                    và Lý, có bài báo trên tạp chí Q1, trước khi tốt nghiệp thủ
                    khoa Đại học Phenikaa.
                  </p>
                </li>
                <li className="list-article-item">
                  <h2 className="list-article-item-title">
                    <Link to="/article-details">
                      Hành trình trở thành bác sĩ nội trú xuất sắc của thủ khoa
                      Y Hà Nội
                    </Link>
                  </h2>
                  <p className="list-article-item-content">
                    Học trường huyện, tới giữa lớp 12 mới ôn khối B, Mạnh Hùng
                    không chỉ đỗ Đại học Y Hà Nội, mà sau đó còn trở thành thủ
                    khoa đầu ra, bác sĩ nội trú xuất sắc.
                  </p>
                </li>
              </ul>
            </div>
